...
# 清除账号认证相关
gcloud auth  revoke marshallbao666@gmail.com
...
# storage
gcloud storage cp iobscanibc-stage-db-archive-20251201.tar.gz gs://irisnet-archive-data/iobscanibc/
...
https://docs.cloud.google.com/sdk/gcloud?hl=zh-cn