...
# 一次插入多个值
INSERT INTO `test33`.`services` (`cluster`, `project`, `service`, `image`, `namespace`, `env`) 
VALUES 
    ('ali', 'geo', 'geo-agent-beat', 'ai/geo-agent', 'geo', 'prod'),
    ('ali', 'geo', 'geo-agent-work', 'ai/geo-agent', 'geo', 'prod'),
    ('ali', 'geo', 'geo-bashboard', 'ai/geo-bashboard', 'geo', 'prod'),
    ('ali', 'geo', 'geo-crawler', 'ai/geo-crawler', 'geo', 'prod'),
    ('ali', 'geo', 'geo-website', 'ai/geo-website', 'geo', 'prod'),
    ('ali', 'geo', 'geo-website-server', 'ai/geo-website-server', 'geo', 'prod');
...
# 通配符查询
SELECT * FROM `services` where project like "unuse%"
...
# 去重
SELECT DISTINCT business_code FROM `sms_send_record` 

# 去重计数
SELECT business_code, COUNT(DISTINCT phone_number) FROM sms_send_record GROUP BY business_code;
